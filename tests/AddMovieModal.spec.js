...
describe("AddMovieModal Component", () => {
    ...
    test("should not render modal content when show is false", () => {
        render(_jsx(AddMovieModal, { show: false, handleClose: mockHandleClose, addMovie: mockAddMovie }));
    ...
    test("should render modal content when show is true", () => {
        render(_jsx(AddMovieModal, { show: true, handleClose: mockHandleClose, addMovie: mockAddMovie }));
    ...
    test("should call handleClose when Close button is clicked", () => {
        ...
        const closeButton = allButtons.find((btn) => btn.textContent === "Close");
        if (closeButton) {
    ...
    test("should call addMovie with correct data when Save Changes is clicked", () => {
        ...
        expect(mockAddMovie).toHaveBeenCalledWith(expect.objectContaining({
            id: "test-video-id",
            title: "",
            rating: 0,
            description: "",
