...
const MockFormComponent = ({ onSubmit, }) => {
    ...
    return (_jsxs("form", { "data-testid": "mock-form", children: [_jsxs("div", { children: [_jsx("label", { htmlFor: "name-input", children: "Full Name" }), _jsx("input", { id: "name-input", type: "text", value: name, onChange: (e) => setName(e.target.value), "data-testid": "name-input" })] }), _jsx("div", { children: _jsxs("label", { children: [_jsx("input", { type: "checkbox", checked: subscribe, onChange: (e) => setSubscribe(e.target.checked), "data-testid": "subscribe-checkbox" }), "Subscribe to newsletter"] }) }), _jsxs("fieldset", { children: [_jsx("legend", { children: "Choose a plan" }), _jsxs("label", { children: [_jsx("input", { type: "radio", name: "plan", value: "basic", checked: plan === "basic", onChange: (e) => setPlan(e.target.value) }), "Basic Plan"] }), _jsxs("label", { children: [_jsx("input", { type: "radio", name: "plan", value: "premium", checked: plan === "premium", onChange: (e) => setPlan(e.target.value) }), "Premium Plan"] }), _jsxs("label", { children: [_jsx("input", { type: "radio", name: "plan", value: "enterprise", checked: plan === "enterprise", onChange: (e) => setPlan(e.target.value) }), "Enterprise Plan"] })] }), _jsx("button", { type: "button", onClick: handleSubmit, children: "Submit" })] }));
};
describe("Advanced Form Testing", () => {
    ...
    test("should handle complete form interaction sequence", () => {
        ...
        render(_jsx(MockFormComponent, { onSubmit: mockSubmit }));
        // Step 1: Enter name
        const nameInput = screen.getByLabelText(/full name/i);
